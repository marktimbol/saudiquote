			...
			<div id="main-slideshow" style="height: 356px;">
				<div class="row">
					<div class="fadein">
						...
						<img src="<?=get_bloginfo('stylesheet_directory');?>/images/new/slide2.jpg" alt="Slide 2" />
						<img src="<?=get_bloginfo('stylesheet_directory');?>/images/new/slide3.jpg" alt="Slide 2" />
